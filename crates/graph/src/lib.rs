...
pub fn large_data_sets_html(show: bool) -> String {
    large_data_sets(show).to_html()
}

// pub fn large_data_sets_img(show: bool) -> String {
//     large_data_sets(show).write_image("out.png", ImageFormat::PNG, 800, 600, 1.0);
// }
